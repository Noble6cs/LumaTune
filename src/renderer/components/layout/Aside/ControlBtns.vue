<template>
  <div ref="dom_btns" :class="$style.controlBtn">
    ...
    <button type="button" :class="[$style.btn, $style.fullscreenToggle]" :aria-label="isFullscreen ? $t('fullscreen_exit') : $t('fullscreen')" ignore-tip :title="isFullscreen ? $t('fullscreen_exit') : $t('fullscreen')" @click="toggleFullscreen">
      <svg :class="[$style.controlBtniIcon, { [$style.fullscreenEnterIcon]: !isFullscreen }]" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="100%" space="preserve">
...
<script setup>
import { minWindow, closeWindow, setFullScreen } from '@renderer/utils/ipc'
