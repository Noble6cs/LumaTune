  ...
  <material-modal :show="!isAgreePact || isShowPact" max-width="70%" :bg-close="isAgreePact" :close-btn="isAgreePact" @close="handleClose(false)">
    <main :class="$style.main">
      ...
      <div class="select scroll" :class="$style.content">
        ...
        <p><strong>修改版说明：</strong>本软件是在&nbsp;<span class="hover underline" @click="openUrl('https://github.com/lyswhut/lx-music-desktop')">LX Music（洛雪音乐助手）</span>&nbsp;开源项目基础上修改的非官方版本；播放器背景算法参考了&nbsp;<span class="hover underline" @click="openUrl('https://github.com/jayfunc/BetterLyrics')">jayfunc/BetterLyrics</span>。</p><br>
...
export default {
  ...
  methods: {
    handleClick() {
      ...
      window.setTimeout(() => {
        this.$dialog({
          message: '本软件完全免费且开源，是基于 LX Music（洛雪音乐助手）开源项目修改的非官方版本。播放器背景算法参考了 jayfunc/BetterLyrics。请支持正版音乐，并注意区分本修改版与 LX Music 官方版本。',
