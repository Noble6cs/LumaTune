...
div(:class="$style.header")
  div(ref="dom_btns" :class="$style.controBtn")
    ...
    button(type="button" :class="$style.fullscreenToggle" :aria-label="isFullscreen ? $t('fullscreen_exit') : $t('fullscreen')" ignore-tip :title="isFullscreen ? $t('fullscreen_exit') : $t('fullscreen')" @click="toggleFullscreen")
      svg(:class="[$style.controBtnIcon, { [$style.fullscreenEnterIcon]: !isFullscreen }]" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="100%")
