...
export const saveRecentPlayListRecords = (records: Array<{ listId: string, musicId: string }>) => {
  rendererSend(WIN_MAIN_RENDERER_EVENT_NAME.save_data, {
    path: DATA_KEYS.recentPlayListRecords,
    data: records,
  })
}

export const getRecentPlayListRecords = async() => {
  return rendererInvoke<string, Array<{ listId: string, musicId: string }> | null>(WIN_MAIN_RENDERER_EVENT_NAME.get_data, DATA_KEYS.recentPlayListRecords)
}
